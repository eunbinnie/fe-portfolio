    ...
    role: [
      {
        ...
        solve:
          'React Query의 SSR prefetching을 도입해 초기 데이터를 서버에서 미리 가져오는 방식으로 로딩 시간을 단축했습니다. 이를 통해 초기 LCP를 1.0초로 줄이며 성능을 개선했습니다. 또한, 사용자의 행동에 따라 필요한 데이터를 즉시 업데이트할 수 있도록 refetch 기능을 구현해 데이터 최신성을 유지하며 사용자 경험을 향상시켰습니다.',
      },
      {
